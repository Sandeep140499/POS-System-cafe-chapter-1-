...
type MenuSection = {
  label: string;
  items: { label: string; icon: ReactNode; to: string; dot?: boolean }[];
};
  ...
  return (
    <ListItemButton
      ...
      sx={{
        ...
        '&:hover': {
          bgcolor: active ? activeHoverBg : 'rgba(255,255,255,0.06)',
          color: '#fff',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          to: '/super-admin/work-hours',
        },
        {
          label: 'Overtime',
          icon: <TimerOutlinedIcon sx={{ fontSize: 20 }} />,
          to: '/super-admin/overtime',
        },
        {
          label: 'Late Entries',
          icon: <WatchLaterOutlinedIcon sx={{ fontSize: 20 }} />,
          to: '/super-admin/late-entries',
        },
        {
          label: 'Leave Requests',
          icon: <BeachAccessOutlinedIcon sx={{ fontSize: 20 }} />,
          to: '/super-admin/leave-requests',
        },
        {
          label: 'Certificates',
      ...
      items: [
        {
          ...
          to: '/employee/live-orders',
          dot: true,
        },
        {
          label: 'Add Order',
          icon: <AddBoxOutlinedIcon sx={{ fontSize: 20 }} />,
          to: '/employee/add-order',
        },
        {
          label: 'All Orders',
          icon: <ShoppingCartOutlinedIcon sx={{ fontSize: 20 }} />,
          to: '/employee/all-orders',
        },
        {
          label: 'Paid & Pending',
          icon: <PaymentOutlinedIcon sx={{ fontSize: 20 }} />,
          to: '/employee/paid-pending',
        },
      ],
    },
    {
      ...
      items: [
        {
          label: 'My Shift',
          icon: <WorkHistoryOutlinedIcon sx={{ fontSize: 20 }} />,
      ...
      >
        <Avatar
          sx={{
            width: 32,
            height: 32,
            bgcolor: isEmployee ? '#8d6e63' : '#c86030',
            fontSize: 12,
            fontWeight: 600,
          }}
        >
        ...
        <Box sx={{ flex: 1, overflow: 'hidden' }}>
          ...
          <Typography
            sx={{ color: 'rgba(255,255,255,0.4)', fontSize: 10.5, fontFamily: 'Inter, sans-serif' }}
          >
      ...
      >
        <Toolbar disableGutters sx={{ minHeight: '54px !important', gap: 1 }}>
          ...
          <Breadcrumbs separator={<ChevronRightIcon sx={{ fontSize: 14, color: '#bbb' }} />}>
            ...
            <Typography
              sx={{ color: '#333', fontSize: 14, fontWeight: 500, fontFamily: 'Inter, sans-serif' }}
            >
          ...
          <Box sx={{ textAlign: 'right', ml: 1, display: { xs: 'none', lg: 'block' } }}>
            ...
            <Typography
              sx={{ fontSize: 11, color: '#999', lineHeight: 1.2, fontFamily: 'Inter, sans-serif' }}
            >
              {timeStr}
            </Typography>
          </Box>
          ...
          >
            <MenuItem component={RouterLink} to={rolePaths.profile}>
              <ListItemIcon>
                <PersonIcon fontSize="small" />
              </ListItemIcon>
              Profile
            </MenuItem>
            <MenuItem component={RouterLink} to={rolePaths.settings}>
              <ListItemIcon>
                <SettingsIcon fontSize="small" />
              </ListItemIcon>
              Settings
            </MenuItem>
            <MenuItem component={RouterLink} to={paths.auth.login}>
              <ListItemIcon>
        ...
        <Box sx={{ p: 2 }}>
          {notifications.length === 0 ? (
            <Box sx={{ textAlign: 'center', py: 6 }}>
              <Typography sx={{ fontSize: 14, color: '#999', fontFamily: 'Inter, sans-serif' }}>
                No notifications
              </Typography>
            </Box>
          ) : (
            notifications.map(n => (
              ...
              >
                ...
                >
                  ...
                  {!n.read && (
                    <Box
                      sx={{ width: 6, height: 6, borderRadius: '50%', bgcolor: '#c86030', mt: 0.5 }}
                    />
                  )}
                </Box>
                <Typography
                  sx={{ fontSize: 12, color: '#666', fontFamily: 'Inter, sans-serif', mb: 0.5 }}
                >
                  {n.message}
                </Typography>
                <Typography sx={{ fontSize: 10.5, color: '#bbb', fontFamily: 'Inter, sans-serif' }}>
                  {n.time}
                </Typography>
              </Box>
            ))
