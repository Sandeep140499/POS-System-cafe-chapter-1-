...
export interface MenuItemData {
  ...
  prices?: {
    single?: number; // For single price items
    half?: number;   // For half/full
    full?: number;   // For half/full (main price)
    option1?: number; // First option price (6 inch, 5 pcs, etc.)
    option2?: number; // Second option price (9 inch, 8 pcs, etc.)
  };
...
export const MENU_CATEGORIES: MenuCategoryData[] = [
  {
    id: 1, name: "Cold Coffee", image: "https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=400&q=80",
    isNewLaunch: true,
    items: [
  ...
  {
    id: 2, name: "Milkshakes", image: "https://images.unsplash.com/photo-1572490122747-3968b75cc699?w=400&q=80",
    isBestSeller: true,
    items: [
  ...
  {
    id: 3, name: "Mocktails", image: "https://images.unsplash.com/photo-1536935338788-846bb9981813?w=400&q=80",
    isNewLaunch: true,
    items: [
  ...
  {
    id: 4, name: "Ice Tea", image: "https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=400&q=80",
    items: [
  ...
  {
    id: 5, name: "Momos", image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b9?w=400&q=80",
    hasHalfFull: true, halfFullLabel: "5pcs / 8pcs", isBestSeller: true,
    items: [
  ...
  {
    id: 6, name: "Pasta", image: "https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=400&q=80",
    items: [
  ...
  {
    id: 7, name: "Sandwich", image: "https://images.unsplash.com/photo-1528735602780-2552fd46c7af?w=400&q=80",
    items: [
  ...
  {
    id: 8, name: "Pizza", image: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400&q=80",
    hasHalfFull: true, halfFullLabel: "6\" / 9\"", isBestSeller: true,
    items: [
  ...
  {
    id: 9, name: "Maggi", image: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?w=400&q=80",
    items: [
  ...
  {
    id: 10, name: "Sweet Corn", image: "https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=400&q=80",
    items: [
  ...
  {
    id: 11, name: "Fries", image: "https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=400&q=80",
    items: [
  ...
  {
    id: 12, name: "Garlic Bread", image: "https://images.unsplash.com/photo-1619535860434-ba1d8fa12536?w=400&q=80",
    items: [
      { id: nid(), name: "Cheese Garlic Bread", price: 99 },
    ],
  },
  {
    id: 13, name: "Burger", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&q=80",
    isBestSeller: true,
    items: [
  ...
  {
    id: 14, name: "Rolls / Wraps", image: "https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=400&q=80",
    items: [
  ...
  {
    id: 15, name: "Rice Bowl", image: "https://images.unsplash.com/photo-1512058564366-18510be2db19?w=400&q=80",
    items: [
  ...
  {
    id: 16, name: "Noodles", image: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400&q=80",
    hasHalfFull: true, halfFullLabel: "Half / Full",
    items: [
  ...
  {
    id: 17, name: "Fried Rice", image: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400&q=80",
    hasHalfFull: true, halfFullLabel: "Half / Full",
    items: [
  ...
  {
    id: 18, name: "Hot Beverages", image: "https://images.unsplash.com/photo-1511920170033-f8396924c348?w=400&q=80",
    items: [
  ...
  {
    id: 19, name: "Chai", image: "https://images.unsplash.com/photo-1571934811356-5cc061b6821f?w=400&q=80",
    items: [
  ...
  {
    id: 20, name: "Soup", image: "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400&q=80",
    items: [
  ...
  {
    id: 21, name: "Slush", image: "https://images.unsplash.com/photo-1570831739435-6601aa3fa4fb?w=400&q=80",
    isNewLaunch: true,
    items: [
  ...
  {
    id: 22, name: "Chilli Chicken", image: "https://images.unsplash.com/photo-1626645738196-c2a7c87a8f58?w=400&q=80",
    items: [
      { id: nid(), name: "Chilli Chicken", price: 179 },
    ],
  },
  {
    id: 23, name: "Fresh Smoothies", image: "https://images.unsplash.com/photo-1505252585461-04db1eb84625?w=400&q=80",
    isNewLaunch: true,
    items: [
      { id: nid(), name: "Strawberry Smoothie", price: 179 },
    ],
  },
  {
    id: 24, name: "Poha", image: "https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?w=400&q=80",
    items: [
      { id: nid(), name: "Poha", price: 99 },
    ],
  },
];
