...
export default function ForgotPasswordPage() {
  ...
  return (
    <Box component="form" onSubmit={handleSend}>
      <Typography sx={{ fontSize: 22, fontWeight: 700, color: "#1a1a1a", mb: 0.5, fontFamily: "Inter, sans-serif" }}>
        Forgot password?
      </Typography>
      ...
      <Typography sx={{ textAlign: "center", fontSize: 13.5, color: "#888", fontFamily: "Inter, sans-serif" }}>
        Remember your password?{" "}
        <Typography
          component={RouterLink}
          to={paths.auth.login}
          sx={{ color: "#c86030", textDecoration: "none", fontWeight: 500, fontFamily: "Inter, sans-serif", "&:hover": { textDecoration: "underline" } }}
        >
          Sign in
        </Typography>
      </Typography>
