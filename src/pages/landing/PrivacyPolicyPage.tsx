    ...
    <Box sx={{ minHeight: '100vh', bgcolor: '#f5f3ef', fontFamily: 'Inter, sans-serif' }}>
      ...
      <Box sx={{ maxWidth: 800, mx: 'auto', px: { xs: 3, md: 5 }, py: 5 }}>
        ...
        <Typography sx={{ fontSize: 14, color: '#555', mb: 3, lineHeight: 1.7 }}>
          When you place an order through our table ordering system, we collect the following
          information:
        </Typography>
        ...
        <Typography sx={{ fontSize: 14, color: '#555', mb: 3, lineHeight: 1.7 }}>
          We use your personal information solely for the purpose of processing your order within
          our restaurant. Specifically:
        </Typography>
        <Box component="ul" sx={{ pl: 3, mb: 3 }}>
          <Typography component="li" sx={{ fontSize: 14, color: '#555', mb: 1, lineHeight: 1.7 }}>
        ...
        <Typography sx={{ fontSize: 14, color: '#555', mb: 3, lineHeight: 1.7 }}>
          <strong>We do not share your data with any third parties.</strong> Your information is
          used exclusively within Cafe Chapter 1 Restaurant Pvt. Ltd. for order processing purposes.
          We do not sell, rent, or trade your personal information to any external organizations.
        </Typography>
        ...
        <Typography sx={{ fontSize: 14, color: '#555', mb: 3, lineHeight: 1.7 }}>
          We retain your order information for a reasonable period necessary for business
          operations, accounting, and legal compliance. Typically, order records are retained for up
          to one year, after which they are securely deleted or anonymized.
        </Typography>
        ...
        <Box sx={{ bgcolor: '#faf9f7', borderRadius: '12px', p: 3, mb: 3 }}>
          ...
          <Typography sx={{ fontSize: 13, color: '#666', mb: 0.5 }}>📞 +91-7800327061</Typography>
          <Typography sx={{ fontSize: 13, color: '#666' }}>✉ chapteronecafe11@gmail.com</Typography>
        </Box>
